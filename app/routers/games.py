...
def _verification_criteria_for_step(run: GameRun, step: GameRunStep) -> str:
    ...
    if run.module_key == "tiptoeing":
        return (
            ...
            "Masken-Regel: Gruene Bereiche markieren erlaubte Fusszonen, schwarze Bereiche sind fuer die Fuesse verboten. "
            "Zehenspitzen-Regel: Die Person soll sichtbar auf den Zehenspitzen stehen; abgesenkte oder aufliegende Fersen sind ein Verstoss. "
