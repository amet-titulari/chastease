...
class AuthUser(Base):
    ...
    setup_wearer_nickname = Column(String(80), nullable=True)
    setup_hard_limits = Column(Text, nullable=True)
    setup_penalty_multiplier = Column(Float, nullable=True)
    setup_gentle_mode = Column(Boolean, nullable=False, default=False)
