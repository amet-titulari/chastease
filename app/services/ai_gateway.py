...
class OllamaGateway(AIGateway):
    ...
    def _chat_prompt(
        ...
        prompt_parts.append(
            ...
            "Fuer kurze, klar begrenzte Toy-Impulse oder einen sofortigen Stopp darfst du toy_control (oder lovense_control) nutzen. "
            "Fuer laenger gefuehrte Toy-Sequenzen mit kurzen Segmenten darfst du toy_session_plan (oder lovense_session_plan) nutzen, aber nie fuer offene Dauersteuerung oder Endlosschleifen."
        )
        ...
        messages.append(
            {
                ...
                "content": (
                    ...
                    "Fuer kurze, klar begrenzte Toy-Impulse oder einen sofortigen Stopp darfst du toy_control (oder lovense_control) mitsenden. "
                    "Fuer laenger gefuehrte Toy-Sequenzen mit kurzen Segmenten darfst du toy_session_plan (oder lovense_session_plan) mitsenden, aber nie fuer offene Dauersteuerung oder Endlosschleifen."
                ),
            }
        )
