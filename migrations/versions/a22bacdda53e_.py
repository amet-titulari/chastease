...
Revision ID: a22bacdda53e
Revises: 
Create Date: 2024-02-24 18:39:05.711244
...
def upgrade():
    ...
    op.create_table('history_chaster',
    ...
    op.create_table('history_ttlock',
    sa.Column('hist_id', sa.String(length=128), nullable=False),
    sa.Column('benutzer_id', sa.Integer(), nullable=False),
    sa.Column('lock_id', sa.String(length=128), nullable=True),
    sa.Column('type', sa.String(length=128), nullable=True),
...
def downgrade():
    ...
    op.drop_table('history_ttlock')
    op.drop_table('history_chaster')
