    ...
    def generate_narration_with_profile(
        ...
        *,
        ...
        system_prompt = (
            ...
            "Use image_verification whenever you REQUEST a specific verification photo from the user — "
            "whether the user asks for it ('check if device is locked', 'verify the seal') "
            "OR when you proactively ask the user to send a proof photo as part of the narrative "
            "(e.g. asking for a photo of the cage, lock, or seal to verify compliance). "
            "If your narrative text asks the user to send a photo for proof or verification, "
            "you MUST also append the machine line [[REQUEST:image_verification|{...}]]. "
