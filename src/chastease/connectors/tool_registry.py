...
def build_default_tool_registry() -> ToolRegistry:
    ...
    registry.register("hygiene_open", ToolPolicy(allow_execute=True, allow_suggest=True))
    registry.register("hygiene_close", ToolPolicy(allow_execute=True, allow_suggest=True))
    registry.register("ttlock_open", ToolPolicy(allow_execute=False, allow_suggest=False))
    registry.register("ttlock_close", ToolPolicy(allow_execute=False, allow_suggest=False))
